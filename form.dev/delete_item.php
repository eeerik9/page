 ...
 if ($database) {     
  ...
  if (!$dbcheck) {             
   ...
   if (isset($_POST['edit'] )){
    ...
    echo '
    <form action="edit_item.php" method="post">    <textarea name="edit_area">'. $row["text"].'</textarea> <input type="hidden" name="to_edit" value="'.$_POST['to_edit'].'"><input type="submit">    </form> ';
   }
  }
 }
?>
