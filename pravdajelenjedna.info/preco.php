...
if (!isset($_SESSION["current"]) || $_SESSION["current"] >= $items_num ){
 $current = 1;
} else {
...
$content = array(
 ...
 2 => array("Realita", "Nanestastie to co vacsina ludi vnima ako skutocne vramci reality je v podstate neskutocne. Za skutocne povazujeme ekonomicky system, legalese, stanovy a regulacie politikov. Ked v skutocnosti su tieto veci najfitivnejsie aspekty naseho celeho socialneho systemu. Su vytvorenie na zotrocenie populacie a extrahovanie vsetkeho co je skutocne od 
ludi.","Max Igan"),
 ...
 27 => array("Sposob (Ako?)", "Sposob sa odraza v tebe ako nekonecny zdroj tvojej inspiracie, ako zdroj tvojej vasne, tvojej mudrosti, tvojho entuziazmu, tvojej intuicie, tvojho duchovneho ohna, tvojej lasky. Sposob zoberie chaos vesmiru a vdychne don zivot a usporiada ho. Ked je sposob vyjadreny myslou, je to genius. Ked je vnimany ocami, je to krasa. Ked je citeny zmyslami, je to ladnost. Ked prijaty do srdca, je to laska. A preto dusa nie je nic co by sa dalo najst. Dusa je sposob akym veci robis.", "Wayseer"),
