...
// table msgs
 ...
 $sql ="CREATE TABLE chat_chatrooms ( id INT(6) UNSIGNED AUTO_INCREMENT PRIMARY KEY,chatname  VARCHAR(10) NOT NULL, users VARCHAR(256) NOT NULL, creator VARCHAR(20) NOT NULL)";
